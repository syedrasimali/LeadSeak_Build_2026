...
function SiteFooter() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 py-12 sm:px-10 sm:py-20">
        <div className="grid gap-8 sm:gap-12 lg:grid-cols-[1.5fr_repeat(3,1fr)]">
          {/* Brand column */}
          <div
            ref={(el) => {
            ...
            <div className="mt-2 rounded-xl border border-line bg-surface/40 p-4 backdrop-blur-sm transition-all duration-300 hover:border-electric-500/20">
              ...
              <div className="mt-3 flex gap-3">
                <a
                  ...
                  aria-label="Twitter"
                  className="grid size-10 place-items-center rounded-lg border border-line bg-canvas-subtle text-content-muted transition-all duration-200 hover:border-electric-500/24 hover:text-electric-400 hover:float-animation"
                >
