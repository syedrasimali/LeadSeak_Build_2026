      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-body text-content-secondary">
            ...
            The work is not hard — it is endless.
          </p>
        </Reveal>
            ...
            {steps.map((step, i) => {
              ...
              return (
                <li key={step.label} className="relative">
                  <Reveal delay={i * 100}>
                    <div
                      className={`h-full rounded-xl border bg-surface p-3 sm:p-4 transition-colors duration-300 ${
                        isLast
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        <span
                          className={`grid size-7 sm:size-8 place-items-center rounded-lg border ${
                            isLast
                        ...
                        <span className="font-mono text-caption text-content-disabled">
